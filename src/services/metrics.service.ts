...
export class MetricsService {
  ...
  async getDashboardMetrics(): Promise<DashboardMetrics> {
    ...
    const studioDefinitions = [
      { id: 'netflix', name: 'Netflix Originals', nameAr: 'نتفليكس', query: 'or=(studios_json.cs.[{"id":178464}],studios_json.cs.[{"id":185004}],studios_json.cs.[{"id":171251}],studios_json.cs.[{"id":145174}],studios_json.cs.[{"id":198834}],studios_json.cs.[{"id":192478}])', color: '#E50914' },
      { id: 'warner', name: 'Warner Bros. Pictures', nameAr: 'وارنر برذرز', query: 'or=(studios_json.cs.[{"id":174}],studios_json.cs.[{"id":429}],studios_json.cs.[{"id":9993}],studios_json.cs.[{"id":128064}],studios_json.cs.[{"id":12}])', color: '#005BBB' },
      { id: 'universal', name: 'Universal Pictures', nameAr: 'يونيفرسال', query: 'or=(studios_json.cs.[{"id":33}],studios_json.cs.[{"id":10146}])', color: '#3B82F6' },
      { id: 'sony', name: 'Sony & Columbia', nameAr: 'سوني بيكتشرز', query: 'or=(studios_json.cs.[{"id":5}],studios_json.cs.[{"id":34}],studios_json.cs.[{"id":2251}],studios_json.cs.[{"id":559}])', color: '#002B66' },
      { id: 'paramount', name: 'Paramount Pictures', nameAr: 'باراماونت', query: 'or=(studios_json.cs.[{"id":4}],studios_json.cs.[{"id":24955}],studios_json.cs.[{"id":2348}])', color: '#0064B0' },
      { id: 'marvel', name: 'Marvel Studios', nameAr: 'مارفل ستوديوز', query: 'or=(studios_json.cs.[{"id":420}],studios_json.cs.[{"id":11106}],studios_json.cs.[{"id":13252}],studios_json.cs.[{"id":7505}])', color: '#ED1D24' },
      { id: 'disney', name: 'Walt Disney Pictures', nameAr: 'ديزني', query: 'or=(studios_json.cs.[{"id":2}],studios_json.cs.[{"id":6125}])', color: '#1B60C4' },
      { id: '20th_century', name: '20th Century Studios', nameAr: 'توينتيث سينشري', query: 'or=(studios_json.cs.[{"id":127928}],studios_json.cs.[{"id":25}],studios_json.cs.[{"id":43}],studios_json.cs.[{"id":9383}])', color: '#DCA227' },
      { id: 'lionsgate', name: 'Lionsgate Films', nameAr: 'لايونزغيت', query: 'or=(studios_json.cs.[{"id":1632}],studios_json.cs.[{"id":35}],studios_json.cs.[{"id":85885}])', color: '#9B51E0' },
      { id: 'amazon', name: 'Amazon MGM Studios', nameAr: 'أمازون إم جي إم', query: 'or=(studios_json.cs.[{"id":20580}],studios_json.cs.[{"id":21}])', color: '#FF9900' },
